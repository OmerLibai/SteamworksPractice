 ...
 * A command that makes the robot to take in a gear (by using the method inTake)
 * When the command ends or interrupted it runs the method stopCollector
 */
public class InTakeCollectorCommmand extends Command{
	 ...
	 */
	public InTakeCollectorCommmand() {
	...
	/**
	 * It runs the inTake method until it is told to stop
	 */
	@Override
