 ...
 * A command that makes the robot Raises the gear (by using the method Raise)
 * When the command ends or interrupted it runs the method stopRaise
 */
public class RaiseCollectorCommand extends Command{
	...
	/**
	 * It runs the Raise method until it is told to stop
	 */
	@Override
	...
	/**
	 * If the command is interrupted, It runs the stopRaise method
	 */
	@Override
