 ...
 * A command that makes the robot close the raiser (by using the method openSlide)
 */
public class CloseRaise extends Command {
    ...
    /**
	 * It runs the closeRaise method until it is told to stop
	 */
