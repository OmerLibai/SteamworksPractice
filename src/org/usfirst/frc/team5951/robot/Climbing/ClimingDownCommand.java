 ...
 * A command that makes the robot to climb up (by using the method climbDown)
 * When the command ends or interrupted it runs the method stop 
 */
public class ClimingDownCommand extends Command {
	...
	/**
	 * It runs the climbingDown method until it is told to stop
	 */
	@Override
	protected void execute() {
		climber.climbingDown();
	}
